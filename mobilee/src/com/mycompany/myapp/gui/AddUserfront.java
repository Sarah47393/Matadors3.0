 ...
 * @author bhk
 */
public class AddUserfront extends Form{
private String fileNameInServer = "";
Form current;
    public AddUserfront(Form previous) {
            ...
            public void actionPerformed(ActionEvent evt) {
                ...
                else
                {
                    try {
                        ...
                        User t = new User(Integer.parseInt(tfPassword.getText()),Integer.parseInt(tfCin.getText()), tfNom.getText(),tfPrenom.getText(),tfDatenaissance.getText(),tfAccess.getText(),fileNameInServer);
                        if( ServiceUser.getInstance().addUserf(t))
                        {
                           Dialog.show("Success","Connection accepted",new Command("OK"));
                           int exx=t.getId();
                            new Affichuser(current,t,exx).show();
                        }else
        ...
        addAll(tfNom,tfPrenom,tfPassword,tfDatenaissance,tfAccess,tfImage,tfCin,imgBtn,btnValider);
